#!/usr/bin/env python3
"""Pre-registered SCREEN and HELD-OUT e1_panels.
...
SCREEN: dict[str, Any] = {
    "e1_exact_dp": {
        # set-based e1_candidates and the circular-window sampler (small anchor state)
        "main": {
            "e1_candidates": ["S0", "S1", "S1n", "S1f", "S5-CIRC", "C-OFFBY1", "C-OFFBY1b", "C-NOACCEPT"],
        ...
        "ordered": {
            "e1_candidates": ["C-FIFO", "C-RR", "C-SLOT0"],
    ...
    "matched_verdicts": {
        "e1_candidates": ["S0", "S1", "S1n", "S1f", "S5-CIRC", "C-NOACCEPT"],
    ...
    "e1_montecarlo": {
        "e1_candidates": ["S0", "S1n", "S5-CIRC", "C-NOACCEPT"],
        "n": 200,
        "k": 10,
        "T": 100_000,
        "R": 200,
...
HELDOUT: dict[str, Any] = {
    "e1_exact_dp": {
        "main": {
            "e1_candidates": ["S0", "S1", "S1f", "S1n", "S5-CIRC"],
            "cells": [(15, 3), (16, 3), (17, 3), (18, 3), (15, 5), (16, 5), (17, 5), (18, 5)],
            "stop_on_first_fail": False,
        }
    },
    "e1_fibermap": {"cells": [(i, 3) for i in range(14, 18)] + [(i, 5) for i in range(14, 18)]},
    "e1_montecarlo": {
